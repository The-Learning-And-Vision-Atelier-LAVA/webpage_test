...
export const Bannerimages = reactive<CarouselItem[]>([
    { url: "/${import.meta.env.VITE_BASE_PATH}/carousel/1.jpg", text: "中山大学深圳校区激光SLAM建图结果" },
    { url: "/${import.meta.env.VITE_BASE_PATH}/carousel/2.jpg", text: "左：高灵活度桌面抓取机器人\n右：野外智能抓取机器人" },
    { url: "/${import.meta.env.VITE_BASE_PATH}/carousel/3.jpg", text: "大场景高精度建图的移动激光扫描车" },
    // 可以根据需要添加更多的图片数据
]);