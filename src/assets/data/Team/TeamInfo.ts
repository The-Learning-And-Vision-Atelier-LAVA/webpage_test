...
export const FacultytableData = computed<Person[]>(() => [
    {'name': '郭裕兰',
        'title': '教授',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/GuoYulan.jpeg`,
        'area': ' 三维视觉与机器人\n\n获中国计算机学会自然科学一等奖',
    ...
    {'name': '张鹏',
        'title': '副教授',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/ZhangPeng.jpeg`,
        'area': '高分辨率对地观测\n\n获省部级科技进步三等奖2次',
        'url': '',
    ...
    {'name': '高庆',
        'title': '副教授',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/GaoQing.png`,
        'area': '机器人具身智能\n\n入选深圳市海外高层次人才',
    ...
    {'name': '张瑞茂',
        'title': '副教授',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/ZhangRuimao.jpg`,
        'area': '机器人具身智能\n\n入选深圳市海外高层次人才',
    ...
    {'name': '张晔',
        'title': '博士后',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/Zhangye.jpg`,
        'area': '时序信号处理\n\n获高分图像解译软件大赛冠军',
    ...
    {'name': '王龙光',
        'title': '博士后',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/WangLongguang.png`,
        'area': '底层视觉与加速\n\n入选中国科协青年人才托举工程',
...
export const StafftableData = computed<Person[]>(() => [
    {
        name: '管玮珺',
        title: '科研助理',
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/ra_GuanWeijun.jpg`,
        area: '工程项目落地',
        url: '',
    ...
    },
    {
        name: '廖小剑',
        title: '科研助理',
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/ra_LiaoXiaojian.png`,
        area: '行政助理',
        url: '',
...
export const GraduatetableData = computed<Person[]>(() => [
    ...
    {'name': '马燕妮',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2020_MaYanni.jpg`,
        'area': '点云场景理解',
        'url': '',
    ...
    {'name': '陈铭林',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_ChenMinglin.jpg`,
        'area': '三维重建与生成',
        'url': '',
    ...
    {'name': '李坤洪',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_LiKunhong.jpg`,
        'area': '视觉三维重建',
        'url': '',
    ...
    {'name': '刘砚',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_LiuYan.jpg`,
        'area': '三维感知',
        'url': '',
    ...
    {'name': '王宇坤',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_WangYukun.jpg`,
        'area': '新视角合成、视频生成和编辑',
        'url': '',
    ...
    {'name': '李浩然',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_LiHaoran.jpg`,
        'area': '点云压缩',
        'url': '',
    ...
    {'name': '裴昀',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_PeiYun.jpg`,
        'area': '三维感知、具身智能',
        'url': '',
    ...
    {'name': '宋卓',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_SongZhuo.jpg`,
        'area': '视觉重定位',
        'url': '',
    ...
    {'name': '叶培根',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_YePeigen.jpg`,
        'area': '语义通信',
        'url': '',
    ...
    {'name': '姜润青',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_JiangRunqing.jpg`,
        'area': '模型压缩',
        'url': '',
    ...
    {'name': '郁鹏鹏',
        'title': '遥感图像与点云压缩',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_YuPengpeng.png`,
        'area': '',
        'url': '',
    ...
    {'name': '张勇健',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_ZhangYongjian.jpg`,
        'area': '三维重建、视觉语言导航',
        'url': '',
    ...
    {'name': '陈毅军',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_ChenYijun.jpg`,
        'area': '具身智能',
        'url': '',
    ...
    {'name': '胡启滨',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_HuQibin.jpg`,
        'area': '具身智能',
        'url': '',
        'email': 'huqb@mail2.sysu.edu.cn',
    },
    {'name': '杨荣坤',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_YangRongkun.jpg`,
        'area': '场景理解',
        'url': '',
    ...
    {'name': '张逸',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_ZhangYi.jpg`,
        'area': '具身智能',
        'url': '',
    ...
    {'name': '汪怡',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2025_WangYi.jpg`,
        'area': '具身智能',
        'url': '',
...
//2021
    {'name': '张乐盈',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_ZhangLeying.jpg`,
        'area': '点云语义分割',
        'url': '',
...
//2022
    {'name': '古芷璇',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_GuZhixuan.jpg`,
        'area': '点云重定位',
        'url': '',
    ...
    {'name': '胡菁',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_HuJing.png`,
        'area': '视频手语识别',
        'url': '',
    ...
    {'name': '黄煜幸',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_HuangYuxing.jpg`,
        'area': '遥感图像变化检测',
        'url': '',
    ...
    {'name': '刘雪帆',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_LiuXuefan.jpg`,
        'area': '点云场景理解',
        'url': '',
    ...
    {'name': '覃洋',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_QinYang.jpg`,
        'area': 'SAR图像三维重建',
        'url': '',
    ...
    {'name': '许伟博',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_XuWeibo.jpg`,
        'area': 'SAR图像解译',
        'url': '',
    ...
    {'name': '赵健羽',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_ZhaoJianyu.jpg`,
        'area': '不确定性估计',
        'url': '',
    ...
    {'name': '周佐运',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2022_ZhouZuoyun.jpg`,
        'area': '多视图立体匹配',
        'url': '',
...
//2023
    {'name': '刘洪达',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_LiuHongda.jpg`,
        'area': '图像超分辨率',
        'url': '',
    ...
    {'name': '刘文昊',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_LiuWenhao.jpg`,
        'area': '动态数据剪枝',
        'url': '',
    ...
    {'name': '唐书衡',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_TangShuheng.jpg`,
        'area': '深度伪造检测',
        'url': '',
    ...
    {'name': '吴波鸿',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_WuBohong.jpg`,
        'area': '人物交互识别',
        'url': '',
    ...
    {'name': '徐业兴',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_XuYexing.jpg`,
        'area': '新视角合成',
        'url': '',
    ...
    {'name': '张明宇',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_ZhangMingyu.jpg`,
        'area': '姿态估计',
        'url': '',
    ...
    {'name': '张绪鑫',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_ZhangXuxin.jpg`,
        'area': '图像匹配',
        'url': '',
    ...
    {'name': '张艺欣',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2023_ZhangYixin.jpg`,
        'area': '点云重定位',
        'url': '',
...
// 2024
    {'name': '成先锋',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_ChengXianfeng.jpg`,
        'area': '人形机器人动作和技巧迁移',
        'url': '',
    ...
    {'name': '方佳俊',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_FangJiajun.png`,
        'area': 'SAR目标态势估计',
        'url': '',
    ...
    {'name': '赖缘川',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_LaiYuanchuan.jpg`,
        'area': '运动重定向',
        'url': '',
    ...
    {'name': '李长军',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_LiChangjun.jpg`,
        'area': '',
        'url': '',
        'email': '',
    },
    {'name': '廖宣淇',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_LiaoXuanqi.jpg`,
        'area': '具身抓取',
        'url': '',
    ...
    {'name': '黎逸雄',
        'title': '',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/r2024_LiYixiong.jpg`,
        'area': '具身智能',
        'url': '',
...
export const BachelortableData = computed<Person[]>(() => [
    {
        name: '钟柠泽',
        title: '',
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/r2021_ZhongNingze.jpg`,
        area: '三维重建、具身智能',
        url: '',
...
export const AlumnitableData = computed<Person[]>(() => [
    ...
    {'name': '刘浩',
        'title': '2023届 博士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_LiuHao.jpg`,
        'area': '南洋理工大学博士后',
        'url': '',
        'email': '',
    },
    {'name': '武光辉',
        'title': '2023届 博士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_WuGuanghui.jpg`,
        'area': '小米上海',
        'url': '',
        'email': '',
    },
...
// 2024届硕士
    {'name': '陈佳慧',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_ChenJiahui.jpg`,
        'area': 'idea研究院',
        'url': '',
        'email': '',
    },
    {'name': '陈思宇',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_ChenSiyu.jpg`,
        'area': '荣耀终端有限公司',
        'url': '',
        'email': '',
    },
    {'name': '陈挺',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_ChenTing.jpg`,
    ...
    {'name': '陈梓浩',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_ChenZihao.jpg`,
        'area': '中信银行信用卡中心',
        'url': '',
        'email': '',
    },
    {'name': '赖鹤丰',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_LaiHefeng.jpg`,
        'area': '华为',
        'url': '',
        'email': '',
    },
    {'name': '林增荣',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_LinZengrong.jpg`,
        'area': '上海理想汽车科技公司',
        'url': '',
        'email': '',
    },
    {'name': '刘文硕',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_LiuWenshuo.jpg`,
        'area': '广州公务员',
        'url': '',
        'email': '',
    },
    {'name': '卢铭轩',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_LuMingxuan.jpg`,
        'area': '腾讯',
        'url': '',
        'email': '',
    },
    {'name': '王逸舟',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_WangYizhou.jpg`,
        'area': '百度',
        'url': '',
        'email': '',
    },
    {'name': '肖强',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_XiaoQiang.jpg`,
        'area': '腾讯（深圳）科技有限公司',
        'url': '',
        'email': '',
    },
    {'name': '周晓锋',
        'title': '2024届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2024_ZhouXiaofeng.png`,
        'area': '南方电网',
        'url': '',
        'email': '',
    },
...
// 2023届硕士
    {'name': '方广驰',
        'title': '2023届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_FangGuangchi.jpg`,
        'area': '香港理工大学读博',
        'url': '',
        'email': '',
    },
    {'name': '林思哲',
        'title': '2023届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_LinSizhe.jpg`,
        'area': '罗湖区街道办事处',
        'url': '',
        'email': '',
    },
    {'name': '万骏辉',
        'title': '2023届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_WanJunhui.jpg`,
        'area': '商汤科技',
        'url': '',
        'email': '',
    },
    {'name': '汪赟',
        'title': '2023届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_WangYun.jpg`,
        'area': '香港城市大学读博',
        'url': '',
        'email': '',
    },
    {'name': '危义民',
        'title': '2023届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2023_WeiYimin.jpg`,
        'area': '日本东京大学读博',
        'url': '',
        'email': '',
    },
...
// 2022届硕士
    {'name': '杜沛峰',
        'title': '2022届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2022_DuPeifeng.jpg`,
        'area': '华为海思',
        'url': '',
        'email': '',
    },
    {'name': '杜荣',
        'title': '2022届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2022_DuRong.jpg`,
        'area': '华为',
        'url': '',
        'email': '',
    },
    {'name': '柯晴天',
        'title': '2022届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2022_KeQingtian.jpg`,
        'area': '华为',
        'url': '',
        'email': '',
    },
    {'name': '李明武',
        'title': '2022届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2022_LiMingwu.jpg`,
        'area': '深圳市前海管理局',
        'url': '',
        'email': '',
    },
    {'name': '李一帆',
        'title': '2022届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2022_LiYifan.png`,
        'area': '米兰理工大学读博',
        'url': '',
        'email': '',
    },
...
// 2021届硕士
    {'name': '陈鸿翔',
        'title': '2021届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2021_ChenHongxiang.jpg`,
        'area': '海南省科技厅',
        'url': '',
        'email': '',
    },
    {'name': '郭伟健',
        'title': '2021届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2021_GuoWeijian.jpg`,
        'area': '网易互娱',
        'url': '',
        'email': '',
    },
    {'name': '李坤洪',
        'title': '2021届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2021_LiKunhong.jpg`,
        'area': '中大读博',
        'url': '',
        'email': '',
    },
...
// 2020届硕士
    ...
    {'name': '马燕妮',
        'title': '2020届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2020_MaYanni.jpg`,
        'area': '中大读博',
        'url': '',
        'email': '',
    },
    {'name': '张永聪',
        'title': '2020届 硕士',
        'img': `/${import.meta.env.VITE_BASE_PATH}/avatars/g2020_ZhangYongcong.jpg`,
        'area': '华为2012实验室',
        'url': '',
        'email': '',
    },
...
export const VisitingtableData = computed<Person[]>(() => [
    {
        ...
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/visiting_FuZhiheng.jpg`,
        area: '西澳大学',
        url: '',
        email: '',
    },
    {
        ...
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/visiting_HuQingyong.jpg`,
        area: '牛津大学',
        url: '',
        email: '',
    },
    ...
    },
    {
        ...
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/visiting_WangZi.jpg`,
        area: '国防科技大学',
    ...
    },
    {
        ...
        img: `/${import.meta.env.VITE_BASE_PATH}/avatars/visiting_DangJisheng.jpg`,
        area: '中山大学',
        url: '',
        email: '',
    },
